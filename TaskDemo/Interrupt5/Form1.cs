...
namespace Interrupt
{
    public partial class DemoWindow : Form
    {
        ...
        private void StartButton1_Click(object sender, EventArgs e)
        {
            ...
            StartButton1.Enabled = StartButton2.Enabled = false;
        ...
        private async void StartButton2_Click(object sender, EventArgs e)
        {
            ...
            StartButton1.Enabled = StartButton2.Enabled = true;
            Cancel = false;
        }
        ...
        public async void ComputeLongestSequence(int start, int stop, int delta)
        {
            ...
            // (1) The task has already finished.  The method continues along as usual.
            // (2) The task has not finished.  A Task is created that will wait for the computation Task to complete.
            //     When it does, this new Task will execute the remainder of the method body.  The method return
